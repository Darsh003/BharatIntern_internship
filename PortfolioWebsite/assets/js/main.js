...
const sendEmail = (e) =>{
  ...
  if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
    ...
    contactMessege.textContent = 'Write all the input fields'
      ...
      emailjs.sendForm('service_tl2zz8r','template_r371bbe','#contact-form','ED3BVsltoB41ovE5q').then(() =>{
...
sr.reveal('.home__data, .project__container, .review__container, .footer__container')
